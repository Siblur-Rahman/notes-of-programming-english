      <a href="../github/git_github.php" class="github_active">Git & GitHub</a>
         <ul class=" my_dropdown github_dropdown">                  
            ...
            <li class=" nav-item"><a class=" nav-link" href="#3">3. Git Commit</a></li>
            <li class=" nav-item"><a class=" nav-link" href="#4">4. Git Commit Log</a></li>
            <li class=" nav-item"><a class=" nav-link" href="#5">5. Git Branch</a></li>
            <li class=" nav-item"><a class=" nav-link" href="#6">6. Push</a></li>
